...
class _ProjectionHead(nn.Module):
    """Projection head producing an embedding and classification logits.

    Args:
        in_dim: Dimension of input features from the backbone.
        emb_dim: Dimension of the projected embedding space.
        num_classes: Number of output classes for classification.

    Returns:
        tuple:
            - emb: Projected feature embedding of shape (B, emb_dim).
            - logits: Class logits of shape (B, num_classes).
    """

    def __init__(self, in_dim: int = 512, emb_dim: int = 128, num_classes: int = 229):
        super().__init__()
...
class MCQClusteringNet1(nn.Module):
    """MCQ Clustering model architecture with AttentionPooling.
    ...
    def __init__(self, out_classes):
        ...
        self.backbone.avgpool = _AttentionPooling(in_feats)

        # changes out_features from 1000 to 11
        self.backbone.fc = nn.Linear(in_feats, out_classes)
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        Returns:
            Output a tuple of (embeddings, logits).
        """
        return self.backbone(x)


class MCQClusteringNet2(nn.Module):
    """MCQ Clustering model architecture with ProjectionHead.
    ...
    def __init__(self, out_classes):
        ...
        self.head = _ProjectionHead(
            in_dim=in_feats, emb_dim=128, num_classes=out_classes
        )
