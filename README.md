# <img style="vertical-align:middle" src="assets/favicon.ico" alt="Logo" width="40">  plom\_ml\_clustering  
...
| ---------------- | ---------------------- | ------ | ----- | ------ |
| ResNet34 + TrOCR | Symbol probability (hellinger) + TrOCR embeddings | 0.8955 | 0.9788   | 0.9528 |
